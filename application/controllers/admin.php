...
class admin extends CI_Controller {
	...
	public function upload_jabatan(){
			...
			for ($row = 2; $row <= $highestRow; $row++){                  //  Read a row of data into an array
				...
				if($rowData[0][0] == NULL && $rowData[0][1] == NULL && $rowData[0][2] == NULL && $rowData[0][3] == NULL && $rowData[0][4] == NULL && $rowData[0][5] == NULL && $rowData[0][6] == NULL && $rowData[0][7] == NULL && $rowData[0][8] == NULL && $rowData[0][9] == NULL && $rowData[0][10] == NULL && $rowData[0][11] == NULL && $rowData[0][12] == NULL && $rowData[0][13] == NULL && $rowData[0][14] == NULL && $rowData[0][15] == NULL && $rowData[0][16] == NULL && $rowData[0][17] == NULL&& $rowData[0][18] == NULL&& $rowData[0][19] == NULL&& $rowData[0][20] == NULL && $rowData[0][21] == NULL){
				echo "<script>
						alert('$banyakUpload data sukses di upload');
						window.location.href='http://localhost/assessment/index/balabala.php';
					</script>";
				}
				...
				// } else {
					//sesuaikan nama dengan nama tabel
					$this->mdata->upload_jabatan($jabatan);
					$banyakUpload++;
				// }
			}
			unlink($inputFileName);
